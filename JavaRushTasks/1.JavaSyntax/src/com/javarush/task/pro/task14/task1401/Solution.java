...
public class Solution {
    ...
    static void addUser(User user) {
        ...
        int errorNumber = user.setName(name);
        if(errorNumber == -1) System.out.println(CANNOT_BE_NULL);
        else if(errorNumber == -2) System.out.println(CANNOT_BE_EMPTY);
        else if(errorNumber==-3) System.out.println(CANNOT_CONTAIN_DIGIT);
        else if(errorNumber != 0) System.out.println(UNKNOWN_ERROR);


        errorNumber =user.setAge(age);

        if(errorNumber == -1) System.out.println(CANNOT_BE_NEGATIVE);
        else if (errorNumber == -2) System.out.println(CANNOT_BE_TOO_BIG);
        else if(errorNumber != 0) System.out.println(UNKNOWN_ERROR);
    ...
    static void findUserIndex(User user) {
        if(users.indexOf(user) == -1) System.out.printf(NOT_FOUND, user.getName());
