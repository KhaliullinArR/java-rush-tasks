...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        /*dateTimeList.forEach(x -> System.out.println(x.getDayOfWeek()));*/
    ...
    public static boolean isWeekend(LocalDateTime dateTime) {
        ...
        if(week.equals(DayOfWeek.FRIDAY) && dateTime.getHour() >= 22) return true;
        if(week.equals(DayOfWeek.SUNDAY) && dateTime.getHour() < 23) return true;
       if(week.compareTo(DayOfWeek.FRIDAY) > 0 && week.compareTo(DayOfWeek.SUNDAY) < 0  )return true;
